...
class SplashScreen extends GetView<SplashController> {
      ...
      body: Container(
        ...
        child: Stack(
          children: [
            ...
            _buildDecorativeCircles(controller),

            // Main content
            _buildMainContent(controller),

            // Bottom loading section
            _buildBottomLoading(controller),
          ],
        ),
      ),
    );
  ...
  Widget _buildDecorativeCircles(SplashController controller) {
    return Stack(
  ...
  Widget _buildAppTitle(SplashController controller) {
  ...
  Widget _buildBottomLoading(SplashController controller) {
    return Positioned(
      bottom: 80,
      left: 0,
      right: 0,
