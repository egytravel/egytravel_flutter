...
import '../../../trip_planner/ui/screen/trip_planner_screen.dart';
import '../controller/main_navigation_controller.dart';

// Import the required classes from home_screen.dart
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Obx(() => IndexedStack(
        ...
        children: const [
          HomeContentScreen(), // Home content without navigation bar
          TripPlannerScreen(), // Search/Trip Planner
...
// Home content without bottom navigation
