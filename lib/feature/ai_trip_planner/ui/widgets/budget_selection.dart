...
class BudgetSection extends StatelessWidget {
  ...
  const BudgetSection({required this.controller, super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(
                    child: BudgetChip(label: 'Low', controller: controller)),
                const SizedBox(width: 8),
                Expanded(
                    child: BudgetChip(label: 'Medium', controller: controller)),
                const SizedBox(width: 8),
                Expanded(
                    child: BudgetChip(label: 'High', controller: controller)),
              ],
            ),
          ],
        ),
