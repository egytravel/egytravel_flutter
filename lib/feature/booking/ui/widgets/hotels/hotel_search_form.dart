            ...
            child: Column(
              ...
              children: [
                ...
                _buildAutocompleteField(
                  ...
                  initialValue: controller.hotelDestination.value,
                  onChanged: (value) =>
                      controller.hotelDestination.value = value,
                ),
                    ...
                    Expanded(
                      child: Obx(
                        () => _buildDropdown(
                          label: 'Guests',
                          icon: Icons.person,
                          value: controller.hotelGuests.value.toString(),
                          items: List.generate(
                            10,
                            (index) => (index + 1).toString(),
                          ),
                          onChanged: (value) {
                            controller.hotelGuests.value = int.parse(value!);
                          },
                        ),
                      ),
                    ),
                    ...
                    Expanded(
                      child: Obx(
                        () => _buildDropdown(
                          label: 'Rooms',
                          icon: Icons.hotel,
                          value: controller.hotelRooms.value.toString(),
                          items: List.generate(
                            5,
                            (index) => (index + 1).toString(),
                          ),
                          onChanged: (value) {
                            controller.hotelRooms.value = int.parse(value!);
                          },
                        ),
                      ),
                    ),
